...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 03 mai 2024 à 17:52
...
--
-- Base de données : `vente_de_patisserie_1`
--
...
INSERT INTO `commande` (`id`, `numero_commande`, `date_de_commande`, `id_user`) VALUES
(1, 2224, '2024-01-23', 7),
(2, 2170, '2024-05-03', 7),
(3, 1295, '2024-05-03', 7),
(4, 978, '2024-05-03', 7);
...
INSERT INTO `gateaux` (`id`, `nom_du_gateaux`, `description`, `prix`, `photo`) VALUES
...
INSERT INTO `user` (`id`, `nom`, `prenom`, `email`, `mot_de_passe`, `adresse`, `numero_telephone`, `date_de_naissance`, `role`) VALUES
(7, 'bey', 'nawal', 'nbey34@gmail.com', '$2y$10$BoncR5Z7AusIId9Hcbi/deAas8nZbS/tpm8h2rr/3bKqKa8LyYquy', '12 rue quelque part ici ', '0102030405', '1989-09-04', 'admin');
...
--
ALTER TABLE `detail`
  ADD CONSTRAINT `detail_ibfk_1` FOREIGN KEY (`id_commande`) REFERENCES `commande` (`id`),
  ADD CONSTRAINT `detail_ibfk_2` FOREIGN KEY (`id_gateau`) REFERENCES `gateaux` (`id`);
COMMIT;
