                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="def-number-input number-input safari_only d-flex formCart">
                            <button class="minus update-produit"
                                onClick="decrement_quantity(<?= $gateau['product']['id_gateaux'] ?>, '<?= $gateau['product']['prix']; ?>')">-</button>
                            ...
                            <button class="plus update-produit"
                                onClick="increment_quantity(<?= $gateau['product']['id_gateaux']; ?>, <?= $gateau['product']['prix']; ?>)">
                                +</button>
                        </div>
                        ...
                        <div class="button3">
                            <!-- Bouton Supprimer -->
                            <a href="../model/supprimer_gateau.php?id=<?= $gateau["product"]['id_gateaux'] ?>"
        ...
        <div class="txt-heading">
            <div class="payement">
                ...
                <div class="cart-status">
                    <div>Total Quantity: <span id="total-quantity">
                            <?= $gateaux['totals']['quantity']; ?>
                        </span></div>
                    <div>Total Price: <span id="total-price">
